...
public class AccountDao {
	...
	// 계좌번호, 비번 확인 용 해당 계좌번호의 비밀번호 return
	public String checkAccountPasswd(String accountNum) {
		String sql = "SELECT accountPasswd FROM Account WHERE accountNum = ?";
		return jdbcTemplate.queryForObject(sql, String.class, accountNum);
	}
